  ...
  return (
    <>
      <div className="fixed top-4 left-4 ">
        <Button className=" p-2 bg-blue-500 text-white rounded-full shadow-lg" onClick={() => dispatch(openSidebar())}>
      ...
      {isSidebarOpen && (
        <Drawer open={isSidebarOpen} onClose={() => dispatch(closeSidebar())}>
          <div className="mb-2 flex items-center justify-between p-4">
            ...
            <IconButton variant="text" color="blue-gray" onClick={() => dispatch(closeSidebar())}>
